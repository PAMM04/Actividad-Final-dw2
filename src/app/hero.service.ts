...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    this.messageService.add('Seleccion: Lista de equipos'); // Agrega un mensaje al servicio de mensajes indicando que se han obtenido los héroes
  ...
  getHero(id: number): Observable<Hero> {
    ...
    this.messageService.add(`Seleccion: Equipo seleccionado id=${id}`); // Agrega un mensaje al servicio de mensajes indicando que se ha obtenido un héroe específico
